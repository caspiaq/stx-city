...
;; FEE AND DEX WALLETS
(define-constant STX_CITY_SWAP_FEE_WALLET 'ST3AM1A56AK2C1XAFJ4115ZSV26EB49BVQ10MGCS0)
(define-constant STX_CITY_COMPLETE_FEE_WALLET 'ST3AM1A56AK2C1XAFJ4115ZSV26EB49BVQ10MGCS0)
(define-constant AMM_WALLET 'ST3AM1A56AK2C1XAFJ4115ZSV26EB49BVQ10MGCS0)
(define-constant BURN_ADDRESS 'ST3AM1A56AK2C1XAFJ4115ZSV26EB49BVQ10MGCS0) ;; burn mainnet

(define-constant deployer tx-sender)
(define-constant allow-token .pump-token)
...
(begin
  ...
  (try! (stx-transfer? u1000000 tx-sender 'ST2NEB84ASENDXKYGJPQW86YXQCEFEX2ZQPG87ND))
  (ok true)
)